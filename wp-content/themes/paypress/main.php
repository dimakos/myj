	...
	<div class="videoblock">
		...
		<div class="main-content">	
			<div class="container">
				...
				<strong>Благодаря нашему сервису стало возможным сэкономить на проведении комплексных ремонтных работ</strong>, так как вы лично связываетесь с исполнителем без посредников и третьих лиц. Что безусловно экономит ваше время и деньги.
				...
				Ну а если вдруг у вас возникли, какие-либо проблемы по дому или Вы хотите сделать ремонт, нужно лишь выбрать специалиста из списка по следующим категориям: <strong>сантехник, электрик, столяр (мебельщик), грузчик, строитель и ремонтник, специалист в технике, мастер на все руки,</strong>
